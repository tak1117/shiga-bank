...
#     # ▼▼▼ ここを編集 ▼▼▼
#     # 処理したいMarkdownファイルのパスを直接指定します
#     MD_PATH = 'combined_markdown.md'
    
#     # （例： 'cognitive-load' から変更）
#     # MD_NAME = 'cognitive-load' 
#     # MD_PATH = os.path.join(os.path.dirname(__file__), '..', 'tests/markdowns/', f'{MD_NAME}.md')


#     # 使用するモデルやオプションもここで変更できます
#     MODEL="gpt-4o" # (例: "gpt-4o-2024-11-20" など、お持ちのキーで使えるモデル)
#     IF_THINNING=False
#     THINNING_THRESHOLD=5000
#     SUMMARY_TOKEN_THRESHOLD=200
#     IF_SUMMARY=True # (例: 要約が不要なら False)
#     # ▲▲▲ 編集ここまで ▲▲▲
...
#     output_path = os.path.join(os.path.dirname(__file__), '..', 'results', f'{output_name}_structure.json')
#     os.makedirs(os.path.dirname(output_path), exist_ok=True)
